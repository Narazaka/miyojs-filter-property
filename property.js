...
MiyoFilters.property_initialize = function(argument, request, id, stash) {
  var handlers, property_getter;
  handlers = argument.property_initialize.handlers;
  property_getter = function(property_base, property_with_handler_name, pre_hook, handler_name) {
    ...
    if (!(compiled_property_name in property_base)) {
      for (_i = 0, _len = handlers.length; _i < _len; _i++) {
        ...
        if (property_with_handler_name in property_base) {
          property = property_getter.call(this, property_base, property_with_handler_name, pre_hook, handler_name);
      ...
      if (!(compiled_property_name in property_base)) {
        if (property_name in property_base) {
          property = property_getter.call(this, property_base, property_name, pre_hook, 'plain');
